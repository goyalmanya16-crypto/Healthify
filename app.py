...
gemini_api_key1=os.getenv('Google-API-Key1')
...
st.title(":orange[HealthifyMe]:blue[Your Personal Health Assistant🥗🏋🏽‍♀️]")
st.markdown('''
This application will assist you to get better and customized health advise.
You can ask your health related issues and get the personalised guidance. ''')
